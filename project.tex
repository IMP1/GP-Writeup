...
%TODO Thank Detlef for his faith in me.
}
...
This project ensures a high level of maintainability %TODO ~ADD THIS

%
% A program must be able to be stepped through, that is, a portion of the program (step) must be able to be run on either the host graph, or the resultant graph of a previous step's execution.
% These steps would ideally be of specifiable sizes.
% These steps must be able to be displayed graphically in the GP2 Editor.
% These steps would ideally be displayed in such a way to highlight any changes made in a step.
%
...
\begin{tabular}{p{4cm} | l | l | l}
	...
	\hline
	2 colouring & 5 & ???? & 0.002972 \\
	Dijkstra's shortest path & 3 & ???? & 0.002632 \\
	%TODO ~ADD: ADD "data"
\end{tabular}
