...
% ~ADD: examples of simple graph programs illustrating calling rules (and the rules themselves)

\begin{figure}
\label{fig:simple_program}
\centering
% ~ADD: Make the code portion of this picture truetype
% ~AMMEND: Make this a more interesting program and show some steps of its execution.
\begin{tikzpicture}[scale=2]
